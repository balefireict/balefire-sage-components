...
const metadata = {
    ...
    "apiVersion": 3,
    "name": "balefire/logo-grid-item",
    "title": "Logo Grid Item",
    "category": "balefire",
    "icon": "format-image",
    "description": "A single logo image constrained to a uniform size for logo grid layouts.",
    "keywords": [
        "logo",
        "grid",
        "partner",
    ...
    "textdomain": "balefire",
    "editorScript": "balefire-logo-grid-item-editor",
...
registerBlockType(metadata.name, {
    ...
    edit: ({ attributes, setAttributes }) => {
        const blockProps = useBlockProps({
            className: 'bma-editor-preview bma-editor-preview-logo-grid-item',
        });
        ...
        return el(Fragment, null,
            el(InspectorControls, null,
                el(PanelBody, { title: __('Logo Settings', 'balefire') },
                    el('div', { className: 'components-base-control' },
                        el('label', { className: 'components-base-control__label' }, __('Logo Image', 'balefire')),
                        el(MediaUpload, {
                                ...
                                attributes.imageUrl
                                    ? el('div', { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
                                        el('img', {
                                            ...
                                            style: { maxWidth: '120px', maxHeight: '62px', objectFit: 'contain' },
                                        }),
                                        el('button', {
                                            type: 'button',
                                            onClick: open,
