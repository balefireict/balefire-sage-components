<?php
/**
 * Renderer — delegates to the Blade view for Auto Grid.
 *
...
namespace BalefireInc\Sage\AutoGrid;
...
class Renderer {
	...
	public static function render( array $props, string $wrapper_attributes = '' ): string {
		...
		if ( function_exists( '\Roots\view' ) ) {
			return \Roots\view( 'bma::components.auto-grid', $props )->render();
		}

		// Acorn installed standalone.
		if ( function_exists( '\Acorn\view' ) ) {
			return \Acorn\view( 'bma::components.auto-grid', $props )->render();
		}

		// No Blade runtime available — fail loud, not silent.
		return '<!-- balefire/auto-grid: Sage/Acorn Blade runtime not found. '
