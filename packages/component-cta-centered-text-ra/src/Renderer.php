<?php
/**
 * Renderer — delegates to the Blade view for CTA Centered Text RA.
 *
...
namespace BalefireInc\Sage\CtaCenteredTextRa;
...
class Renderer {
	...
	public static function render( array $props ): string {
		...
		if ( function_exists( '\Roots\view' ) ) {
			return \Roots\view( 'bma::components.cta-centered-text-ra', $props )->render();
		}

		// Acorn installed standalone.
		if ( function_exists( '\Acorn\view' ) ) {
			return \Acorn\view( 'bma::components.cta-centered-text-ra', $props )->render();
		}

		// No Blade runtime available — fail loud, not silent.
		return '<!-- balefire/cta-centered-text-ra: Sage/Acorn Blade runtime not found. '
