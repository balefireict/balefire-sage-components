<?php
/**
 * Renderer — delegates to the Blade view for the video-cards component.
 *
...
namespace BalefireInc\Sage\VideoCards;
...
class Renderer {
	...
	public static function render( array $props, string $wrapper_attributes = '' ): string {
		...
		if ( function_exists( '\Roots\view' ) ) {
			return \Roots\view( 'bma::components.video-cards', $props )->render();
		}

		if ( function_exists( '\Acorn\view' ) ) {
			return \Acorn\view( 'bma::components.video-cards', $props )->render();
		}

		return '<!-- balefire/video-cards: Sage/Acorn Blade runtime not found. '
