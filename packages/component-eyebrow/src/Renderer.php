<?php
/**
 * Renderer — delegates to the Blade view for Eyebrow.
 *
...
namespace BalefireInc\Sage\Eyebrow;
...
class Renderer {
	...
	public static function render( array $props, string $wrapper_attributes = '' ): string {
		...
		if ( function_exists( '\Roots\view' ) ) {
			return \Roots\view( 'bma::components.eyebrow', $props )->render();
		}

		// Acorn installed standalone.
		if ( function_exists( '\Acorn\view' ) ) {
			return \Acorn\view( 'bma::components.eyebrow', $props )->render();
		}

		// No Blade runtime available — fail loud, not silent.
		return '<!-- balefire/eyebrow: Sage/Acorn Blade runtime not found. '
