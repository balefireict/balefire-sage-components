<?php
/**
 * Renderer — delegates to the Blade view for FAQ Items.
 *
...
class Renderer {
	...
	public static function render( array $props ): string {
		...
		if ( function_exists( '\Roots\view' ) ) {
			return \Roots\view( 'bma::components.faq-items', $props )->render();
		}

		// Acorn installed standalone.
		if ( function_exists( '\Acorn\view' ) ) {
			return \Acorn\view( 'bma::components.faq-items', $props )->render();
		}

		// No Blade runtime available — fail loud, not silent.
		return '<!-- balefire/faq-items: Sage/Acorn Blade runtime not found. '
