...
$bma_grid_cell_boot = static function (): void {
	...
	if ( is_admin() && function_exists( 'wp_register_script' ) ) {
		...
		$editor_js = file_get_contents( __DIR__ . '/../blocks/grid-cell/editor.js' );
		if ( $editor_js !== false ) {
			wp_add_inline_script( 'balefire-grid-cell-editor', $editor_js );
		}
	}
