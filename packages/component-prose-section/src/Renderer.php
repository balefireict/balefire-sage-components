<?php
/**
 * Renderer — delegates to the Blade view for the prose section.
 *
...
namespace BalefireInc\Sage\ProseSection;

class Renderer {

	/**
	 * Render the prose section from the given props.
	 *
	...
	public static function render( array $props, string $wrapper_attributes = '' ): string {
		...
		if ( function_exists( '\Roots\view' ) ) {
			return \Roots\view( 'bma::components.prose-section', $props )->render();
		}

		if ( function_exists( '\Acorn\view' ) ) {
			return \Acorn\view( 'bma::components.prose-section', $props )->render();
		}

		return '<!-- balefire/prose-section: Sage/Acorn Blade runtime not found. '
