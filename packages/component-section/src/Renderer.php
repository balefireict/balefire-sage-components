<?php
/**
 * Renderer — delegates to the Blade view for Section.
 *
...
namespace BalefireInc\Sage\Section;
...
class Renderer {
	...
	public static function render( array $props ): string {
		...
		if ( function_exists( '\Roots\view' ) ) {
			return \Roots\view( 'bma::components.section', $props )->render();
		}

		// Acorn installed standalone.
		if ( function_exists( '\Acorn\view' ) ) {
			return \Acorn\view( 'bma::components.section', $props )->render();
		}

		// No Blade runtime available — fail loud, not silent.
		return '<!-- balefire/section: Sage/Acorn Blade runtime not found. '
