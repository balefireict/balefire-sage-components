<?php
/**
 * Renderer — delegates to the Blade view for the CTA band.
 *
...
namespace BalefireInc\Sage\CtaBand;

class Renderer {

	/**
	 * Render the CTA band from the given props.
	 *
	...
	public static function render( array $props, string $wrapper_attributes = '' ): string {
		...
		if ( function_exists( '\Roots\view' ) ) {
			return \Roots\view( 'bma::components.cta-band', $props )->render();
		}

		if ( function_exists( '\Acorn\view' ) ) {
			return \Acorn\view( 'bma::components.cta-band', $props )->render();
		}

		return '<!-- balefire/cta-band: Sage/Acorn Blade runtime not found. '
