<?php
/**
 * Renderer — delegates to the Blade view for the highlight-banner component.
 *
...
namespace BalefireInc\Sage\HighlightBanner;
...
class Renderer {
	...
	public static function render( array $props, string $wrapper_attributes = '' ): string {
		...
		if ( function_exists( '\Roots\view' ) ) {
			return \Roots\view( 'bma::components.highlight-banner', $props )->render();
		}

		if ( function_exists( '\Acorn\view' ) ) {
			return \Acorn\view( 'bma::components.highlight-banner', $props )->render();
		}

		return '<!-- balefire/highlight-banner: Sage/Acorn Blade runtime not found. '
