<?php
/**
 * Renderer — delegates to the Blade view for the compare-cards component.
 *
...
namespace BalefireInc\Sage\CompareCards;
...
class Renderer {
	...
	public static function render( array $props, string $wrapper_attributes = '' ): string {
		...
		if ( function_exists( '\Roots\view' ) ) {
			return \Roots\view( 'bma::components.compare-cards', $props )->render();
		}

		if ( function_exists( '\Acorn\view' ) ) {
			return \Acorn\view( 'bma::components.compare-cards', $props )->render();
		}

		return '<!-- balefire/compare-cards: Sage/Acorn Blade runtime not found. '
